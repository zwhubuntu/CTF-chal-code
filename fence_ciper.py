...
for i in range(0,111):
    print decryptRailFence("AaY--rpyfneJBeaaX0n-,ZZcs-uXeeSVJ-sh2tioaZ}slrg,-ciE-anfGt.-eCIyss-TzprttFliora{GcouhQIadctm0ltt-FYluuezTyorZ-", i, 0); #(reference: http://i.imgur.com/kWGmM.gif)